...
LRESULT CALLBACK WndProc(HWND hWnd, UINT messg,
    ...
    case WM_PAINT :
        ...
        double** DFS_tree = (double**)malloc(N * sizeof(double*));
        for (int i = 0; i < N; i++){
            DFS_tree[i] = (double*)malloc(N * sizeof(double));
        }
        ...
        //DFS algorithm
        void DFS(double** adjMatrix, int startVertex){
        ...
        //DFS call
        DFS(matrix, 0);
        printf("DFS tree matrix:\n");
        printMatrix(DFS_tree, n, n);
